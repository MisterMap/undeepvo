...
class GroundTruthDataset(object):
    def __init__(self, main_folder='depth_selection', length=600):
    ...
    def get_depth(self, idx):
        assert idx < self._length, "Out of dataset"
        name_for_depth = '{}groundtruth_depth{}image{}'.format(self._names[idx].split("image")[0], self._names[idx].split("image")[1], self._names[idx].split("image")[2])
