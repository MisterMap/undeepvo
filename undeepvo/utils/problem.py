...
class Problem(abc.ABC):
    ...
    def train(self, n_epoch=20, batch_size=128):
        train_batches = self._dataset_manager.get_train_batches(batch_size)
    ...
    def get_validation_metrics(self):
        return self.evaluate_batches(self._dataset_manager.get_validation_batches(self._validation_batch_size))

    def get_test_metrics(self):
        return self.evaluate_batches(self._dataset_manager.get_test_batches(self._validation_batch_size))
