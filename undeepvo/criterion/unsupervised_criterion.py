...
class UnsupervisedCriterion(nn.Module):
    ...
    def forward(self, left_current_output: ResultDataPoint, right_current_output: ResultDataPoint,
        ...
        return (current_spatial_loss + next_spatial_loss, current_photometric_loss + next_photometric_loss,
                current_disparity_loss + next_disparity_loss, current_pose_loss + next_pose_loss)
