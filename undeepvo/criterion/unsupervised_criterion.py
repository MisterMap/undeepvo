...
from .losses import SpatialLosses
...
class UnsupervisedCriterion(nn.Module):
    ...
    def forward(self, left_current_output: ResultDataPoint, right_current_output: ResultDataPoint,
        ...
        current_spatial_loss = self.spatial_losses(left_current_output.input_image,
        ...
        next_spatial_loss = self.spatial_losses(left_next_output.input_image,
        ...
        return current_spatial_loss + next_spatial_loss
