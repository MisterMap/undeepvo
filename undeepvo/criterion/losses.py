...
class TemporalImageLosses(torch.nn.Module):
    ...
    def forward(self, left_current_image, left_next_image, left_current_depth, left_next_depth,
        ...
        left_temporal_photometric_loss = self.temporal_photometric_consistency_loss(left_current_image,
                                                                                    left_next_image,
                                                                                    left_current_depth,
                                                                                    left_next_depth,
                                                                                    ...
                                                                                    left_next_position,
                                                                                    left_next_angle)
        right_temporal_photometric_loss = self.temporal_photometric_consistency_loss(right_current_image,
                                                                                    right_next_image,
                                                                                    right_current_depth,
                                                                                    right_next_depth,
