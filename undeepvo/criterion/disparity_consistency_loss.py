...
class DisparityConsistencyLoss(torch.nn.Module):
    def __init__(self, Bf, left_camera_matrix, right_camera_matrix, transform_from_left_to_right, lambda_disparity=0.85):
        super().__init__()
        self.Bf = Bf
    ...
    def forward(self, left_current_depth, right_current_depth):
        ...
        return self.lambda_disparity * self.l1_loss(left_disparity, generated_left_disparity) + self.lambda_disparity * self.l1_loss(right_disparity, generated_right_disparity)